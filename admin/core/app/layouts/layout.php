...
<html>
  <head>
    <meta charset="UTF-8">
    <title>TEST | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>TEC</b>NM</span>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2021 <a href="https://test.edomex.gob.mx/" target="_blank">TEST</a></strong>
      </footer>
      <?php else:?>
